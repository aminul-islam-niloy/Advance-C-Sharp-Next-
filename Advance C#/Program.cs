...
//Object initializer in c# 
            ...
            Student student3 = new Student() { Id = 3, Name = "Jamil", Address = "Dhaka", Age = 40 };
            Student student4 = new Student() { Id = 4, Name = "Asgar", Address = "Dhaka", Age = 60 };
...
// add student list without add method.
  ...
  // there are another way to initilaze  collection.
            ...
            {
                new Student() {Id=33, Age=10},
                new Student() {Id=43, Age=20},
                new Student() {Id=53, Age=30}
            };
